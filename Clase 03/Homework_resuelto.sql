...
#CREA DOS TABLA DONDE CONTIENE LOS OUTLIERS
#MOTIVO 2
...
#AGREGA UNA COLUMNA A LA TABLA VENTA QUE TIENE POR DEFECTO 1
ALTER TABLE `venta` ADD `Outlier` TINYINT NOT NULL DEFAULT '1' AFTER `Cantidad`;

#MODIFICA LA TABLA VENTA COLOCANDO 0 DONDE HAY MOTIVO 2 Y 3
...
# INTERSECCION TABLA VENTA PRODUCTO Y TIPO PRODUCTO >> CON Y SIN OUTLIERS
